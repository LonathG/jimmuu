				...
				<div className="flex flex-col md:flex-row items-center space-y-8 md:space-y-0 md:space-x-8 w-full p-4">
					...
					<div className="space-y-4 flex flex-col items-center md:items-start w-auto mx-5 gap-auto">
						...
						>
							...
							<div>
								<h3 className="text-lg font-bold text-[20px]">
									Investigations & Surveillance
								</h3>
								<p className="text-gray-700 text-[11px] my-2">
									Discreet, professional monitoring and fact-finding for legal
									and private matters
								</p>
							</div>
						</motion.div>
						...
						>
							...
							<div>
								...
								<p className="text-gray-700 text-[11px] my-2">
									Advanced solutions to detect and prevent unauthorized
						...
						>
							...
							<div>
								...
								<p className="text-gray-700 text-[13px] my-2">
									Expert analysis and tracking of digital crimes, data breaches,
									and online threats
								</p>
							</div>
						</motion.div>
					...
					{/* Right Side - Content */}
					<div className="image-card hidden md:block flex-1 flex flex-col justify-start items-center md:items-start w-full h-full">
						...
						<div className="image-container relative flex justify-center items-center">
							<img
								src={img}
								alt="Smiling woman with glasses working on a laptop"
