...
const Blogs = () => {
	const cardsData = [
		...
		// },
		{
			imageUrl: `${img4}`,
			title:
				"The Separation of Bill Gates and Melinda French Gates: Philanthropy, Wealth, and a Private Settlement",
	...
	const handleScrollRight = () => {
		const scroller = document.querySelector(".horizontal-scroller");
		scroller.scrollBy({ left: 600, behavior: "smooth" }); // Adjust the scroll distance as needed
	};
